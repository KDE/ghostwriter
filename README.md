...
Build |Ubuntu | Fedora COPR
-------|-------|-----
stable | N/A   | N/A
staging | ![Travis CI](https://img.shields.io/travis/wereturtle/ghostwriter?label=build&logo=Ubuntu&style=flat-square) | ![Fedora COPR](https://copr.fedorainfracloud.org/coprs/wereturtle/staging/package/ghostwriter/status_image/last_build.png)
