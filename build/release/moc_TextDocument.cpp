...
struct qt_meta_stringdata_TextDocument_t {
    QByteArrayData data[3];
    char stringdata[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TextDocument_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TextDocument_t qt_meta_stringdata_TextDocument = {
    {
QT_MOC_LITERAL(0, 0, 12),
QT_MOC_LITERAL(1, 13, 15),
QT_MOC_LITERAL(2, 29, 0)
    },
    "TextDocument\0filePathChanged\0\0"
};
...
void TextDocument::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (TextDocument::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TextDocument::filePathChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject TextDocument::staticMetaObject = {
    { &QTextDocument::staticMetaObject, qt_meta_stringdata_TextDocument.data,
      qt_meta_data_TextDocument,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TextDocument.stringdata))
...
// SIGNAL 0
void TextDocument::filePathChanged()
{
