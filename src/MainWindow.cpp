...
void MainWindow::buildMenuBar()
{
    ...
    editMenu->addAction(tr("Strikthrough"), editor, SLOT(strikethrough()), QKeySequence("Ctrl+k"));
    editMenu->addAction(tr("HTML Comment"), editor, SLOT(insertComment()), QKeySequence("Ctrl+<"));
    editMenu->addSeparator();
    editMenu->addAction(tr("Insert Image..."), this, SLOT(insertImage()));
    editMenu->addSeparator();
    editMenu->addAction(tr("Indent"), editor, SLOT(indentText()), QKeySequence("Tab"));
    editMenu->addAction(tr("Unindent"), editor, SLOT(unindentText()), QKeySequence("Shift+Tab"));
    editMenu->addSeparator();
    editMenu->addAction(tr("Block Quote"), editor, SLOT(createBlockquote()), QKeySequence(">"));
    editMenu->addAction(tr("Strip Block Quote"), editor, SLOT(removeBlockquote()), QKeySequence("Ctrl+>"));
    editMenu->addAction(tr("Bullet List"), editor, SLOT(createBulletList()), QKeySequence("Ctrl+*"));
    editMenu->addAction(tr("Numbered List"), editor, SLOT(createNumberedList()), QKeySequence("Ctrl+1"));
    editMenu->addAction(tr("Task List"), editor, SLOT(createTaskList()), QKeySequence("Ctrl+t"));
    editMenu->addAction(tr("Toggle Task(s) Complete"), editor, SLOT(toggleTaskComplete()), QKeySequence("Ctrl+d"));
    editMenu->addSeparator();
